...
echo "Firefox, hardinfo, chkrootkit, portsentry, lynis, gufw, sysv-rc-conf, rkhunter, and AppArmor have been installed. Coreutils has been reinstalled."
...
echo "Script is complete. Run antivirus/system scan commands from antivirus_commands.txt on the desktop. Check in ~/Desktop/Script.log for some other things to look at. Refer to the checklist for other things to do."
